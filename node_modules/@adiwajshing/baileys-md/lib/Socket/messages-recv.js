...
const makeMessagesRecvSocket = (config) => {
    ...
    const { ev, authState, ws, assertSession, assertingPreKeys, sendNode, relayMessage, sendDeliveryReceipt, resyncMainAppState, } = sock;
    ...
    ws.on('CB:message', async (stanza) => {
        ...
        const remoteJid = WABinary_1.jidNormalizedUser(dec.chatId);
        const key = {
            remoteJid,
            fromMe: isMe,
            id: dec.msgId,
        ...
        if (dec.successes.length) {
            ...
            if (isMe) {
                ...
                if (isGroup || isStatus) {
                    ...
                    recpAttrs.to = WABinary_1.jidNormalizedUser(dec.chatId);
                }
            }
    ...
    const handleReceipt = async (node) => {
        ...
        if (typeof status !== 'undefined' && !WABinary_1.areJidsSameUser(attrs.from, (_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.id)) {
